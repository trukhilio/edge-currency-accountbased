...

{
  ...
  constructor(
    ...
    this.checkBalances = (
      ...
      const sendBalance =
        _nullishCoalesce(this.walletLocalData.totalBalances[sendCurrencyCode], () => ( '0'))
      const feeCurrencyCode = mainnetCode
      const feeBalance =
        _nullishCoalesce(this.walletLocalData.totalBalances[feeCurrencyCode], () => ( '0'))

      if (_biggystring.gt.call(void 0, _biggystring.abs.call(void 0, nativeAmount), sendBalance)) {
        throw new (0, _types.InsufficientFundsError)()
      }
      if (parentNetworkFee != null && _biggystring.gt.call(void 0, parentNetworkFee, feeBalance)) {
        throw new (0, _types.InsufficientFundsError)({
